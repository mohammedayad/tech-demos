package com.ayad.microservicedemo.exercises.advancedfeatures.nestedinneranonymoustypes.innerclass;
...
public class Inventory {
    ...
    public class Reservation {
        ...
        public Reservation(String productCode, int quantity) {
    ...
    public Reservation reserve(String productCode, int quantity) {
        ...
        reserved.merge(productCode, quantity, Integer::sum);
        return new Reservation(productCode, quantity);
    }
